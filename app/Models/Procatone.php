...

{
    ...
    // {
    //     return $this->hasMany('App\Models\Procatone','parent_id');
    // }
    public function chils()
    {
        return $this->hasMany(Procatone::class,'parent_id','id');
    }
    ...
    public function procattwos()
    {
        return $this->hasMany('App\Models\Procattwo');
    }
}