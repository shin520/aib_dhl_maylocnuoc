...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 main-content">
            <nav aria-label="breadcrumb" style="margin-top: 46px" class="mb-3">
                <ol class="breadcrumb shadow-sm">
                    <li class="breadcrumb-item"><a href="{{ route('frontend.home.index') }}" title="{{ $setting->title }}"><i class="ti-home"></i> Trang chủ</a></li>
                    <li class="breadcrumb-item active"><a href="{{ URL::current() }}" title="Tin tức">Tin tức</a></li>
                </ol>
            </nav>
            {{-- <div class="main-title">
                <h1 class="heading text-center" style="color:#222222"><a href="{{ URL::current() }}" title="Tin tức">Tin tức</a></h1>
            </div> --}}
            <div class="row">
