<footer class="footer">
  <div class="tt-footer-default tt-color-scheme-02">
    <div class="container">
      ...
      @endphp
      <a href="http://zalo.me/{{ $hotline_trim_space }}" class="zalo btn-tooltip" data-toggle="tooltip" data-placement="left" data-original-title="Chat Zalo"><img style="vertical-align:inherit;margin-top: 6px;" src="/frontend/images/zalo.png" width="38" alt="icon zalo" title="icon zalo"></a>
      <div class="row">
        <div class="col-md-9">
            ...
            <div class="tt-newsletter">
              <div class="tt-mobile-collapse">
                <div class="bnt-baogia">
                  <a href="/dang-ky-nhan-bao-gia.html"><i class="fa fa-hand-o-right"></i> ĐĂNG KÝ YÊU CẦU BÁO GIÁ</a>
                </div>
              </div>
            </div>
          </div> --}}
          ...
          <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-mb">
            <div class="footer-widget">
              ...
              <ul class="list-menu">
                ...
                <li><a href="{{ route('frontend.home.index') }}/chinh-sach/{{ $policy->slug.'.html' }}">{{ $policy->name }}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-mb">
            <div class="footer-widget">
              ...
              <ul class="list-menu">
                ...
                <li><a href="{{ route('frontend.home.index') }}/huong-dan/{{ $tutorial->slug.'.html' }}">{{ $tutorial->name }}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-mb mb-4">
            <div class="footer-widget">
              ...
              <div class="fb-page" data-href="https://www.facebook.com/T%E1%BB%95ng-kho-l%E1%BB%8Dc-n%C6%B0%E1%BB%9Bc-TaiWan-102938201131502" data-tabs="" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/T%E1%BB%95ng-kho-l%E1%BB%8Dc-n%C6%B0%E1%BB%9Bc-TaiWan-102938201131502" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/T%E1%BB%95ng-kho-l%E1%BB%8Dc-n%C6%B0%E1%BB%9Bc-TaiWan-102938201131502">Tổng kho lọc nước TaiWan</a></blockquote></div>
            </div>
          </div>
        </div>
      </div>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0&appId=415286862818674&autoLogAppEvents=1" nonce="Q9wYVPWO"></script>
</footer> 
        ...
        <li class="ng-scope ng-has-child1">
          ...
          <ul class="ul-has-child1">
            ...
            <li class="ng-scope ng-has-child2">
              <a href="{{ route('frontend.home.index') }}/san-pham/{{ $procatone->slug.'.html' }}">{{ $procatone->name }} <i class="fa fa-plus fa2" aria-hidden="true"></i></a>
              @php
                $procattwos = DB::table('procattwos')->where('procatone_id', $procatone->id)->get();
              @endphp
