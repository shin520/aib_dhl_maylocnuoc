@php
    ...
    // dd($count);
@endphp
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Cảm ơn quý khách <b>{{ $cus_name }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Quý khách đã đặt hàng thành công tại Website: <b>{{ $web }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;"><b>Thông tin đặt hàng:</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Mã đơn hàng: <b>{{ $order_id }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Tên người nhận: <b>{{ $cus_name }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Địa chỉ nhận hàng: <b>{{ $address }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">SĐT nhận hàng: <b>{{ $phone }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Email nhận thông báo: <b>{{ $email }}</b></p>
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;">Ghi chú: <b>{{ $note }}</b></p>
...
<p style="font-family:Arial,Helvetica,sans-serif;font-size:10pt;line-height: 24px;">Trân trọng cảm ơn Quý khách hàng <b>{{ $cus_name }}</b></p>