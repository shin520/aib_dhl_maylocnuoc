...
<script>
  $('document').ready(function () {
    $(document).on('change', 'input#name', function() {
      ...
      $('div#slug1').text('{{ $setting->web }}/danh-muc/'+slug1+'.html');
    });
  });
  $('document').ready(function () {
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="name" id="name" onkeyup="AutoSlug();" value="{{ old('name') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập tên danh mục">
                  ...
                  <div class="form-group">
                    <select class="form-control select2" name="procattwo_id" data-placeholder=" Chọn danh mục"
                      style="width: 100%;">
                      <option value=""> Chọn danh mục</option>
                      @foreach ($procattwos as $procatotwo)
                      <option value="{{ $procatotwo->id }}"> {{ $procatotwo->name }}</option>
                      @endforeach
                    </select>
                  </div> --}}
                      <div class="form-group">
