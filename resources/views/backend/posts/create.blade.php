...
<script>
  $('document').ready(function () {
    $(document).on('change', 'input#name', function() {
      ...
      $('div#slug1').text('{{ $setting->web }}/'+slug1+'.htmI');
    });
  });
  $('document').ready(function () {
...
<div class="content-wrapper" id="pjax-container">
  ...
  <section class="content">
    ...
    @endif
    <form id="stringLengthForm" method="POST" action="{{ route('backend.post.store') }}" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <!-- left column -->
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="name" id="name" {{-- onchange="getTitle()" --}} onkeyup="AutoSlug();" value="{{ old('name') }}" class="form-control" data-toggle="tooltip" data-placement="top" title="Nhập tên bài viết">
              </div>
              <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            <div class="box-body">
              <div class="form-group">
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" name="published" value="">
                </div>
              </div>
            </div>
          </div> --}}
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <label>
                <input type="checkbox" name="hide_show" id="hide_show" value="1" class="minimal" checked="1">
